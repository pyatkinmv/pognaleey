...
class TravelInquiryServiceTest extends DatabaseCleaningTest {
  @Autowired private TravelInquiryService travelInquiryService;
  @Autowired private TravelRecommendationService travelRecommendationService;
  ...
  void createInquiry() {
    ...
    assertThat(inquiry)
        ...
        .ignoringFields("id", "createdAt", "quickRecommendations")
