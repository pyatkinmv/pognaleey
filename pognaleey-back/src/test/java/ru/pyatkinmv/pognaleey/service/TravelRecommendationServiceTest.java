                ...
                .isEqualTo(
                        List.of(
                                new TravelRecommendationDto(-1L, "Грузия, Тбилиси и винные регионы", ProcessingStatus.READY.name(), null,
                                        new ImageDto("Грузия, Тбилиси и винные регионы", "imageUrl", "thumbnailUrl", "Грузия весна пейзаж"), null),
                                new TravelRecommendationDto(-1L, "Париж, Франция: Город любви", ProcessingStatus.READY.name(), null,
                                        new ImageDto("Париж, Франция: Город любви", "imageUrl", "thumbnailUrl", "Париж Эйфелева башня закат"), null),
                                new TravelRecommendationDto(-1L, "Красная Поляна, Сочи: Горнолыжный отдых", ProcessingStatus.READY.name(), null,
                                        new ImageDto("Красная Поляна, Сочи: Горнолыжный отдых", "imageUrl", "thumbnailUrl", "Красная Поляна лыжи снег"), null),
                                new TravelRecommendationDto(-1L, "Индонезия, Бали: Пляжный отдых", ProcessingStatus.READY.name(), null,
                                        new ImageDto("Индонезия, Бали: Пляжный отдых", "imageUrl", "thumbnailUrl", "Бали пляжи закат"), null),
                                new TravelRecommendationDto(-1L, "Исландия: Природные чудеса", ProcessingStatus.READY.name(), null,
                                        new ImageDto("Исландия: Природные чудеса", "imageUrl", "thumbnailUrl", "Исландия водопады ледники"), null)
                        )
                );
    }
