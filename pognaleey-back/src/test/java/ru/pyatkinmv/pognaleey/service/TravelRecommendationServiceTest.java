...
class TravelRecommendationServiceTest {
    ...
    void parse() {
        ...
        var parsed = TravelRecommendationService.parse(recommendationsRaw, GptResponseRecommendationDetailsListDto.class);
