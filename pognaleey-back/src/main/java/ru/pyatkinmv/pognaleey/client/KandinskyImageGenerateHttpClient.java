...
public class KandinskyImageGenerateHttpClient {
    ...
    private final String getUrlFormat = "https://api-key.fusionbrain.ai/key/api/v1/text2image/status/%s";
    ...
    public Optional<KandinskyPostImagesResponseDto> generateImage(String query) {
        ...
        var response = restTemplate.exchange(postUrl,
                HttpMethod.POST, requestEntity, KandinskyPostImagesResponseDto.class);
