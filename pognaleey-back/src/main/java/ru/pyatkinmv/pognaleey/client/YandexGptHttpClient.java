...
public class YandexGptHttpClient implements GptHttpClient {
  ...
  public String ask(String prompt) {
    ...
    var response =
        restTemplate.exchange(
            gptBaseUrl, HttpMethod.POST, requestEntity, YandexGptBodyResponseDto.class);
    var responseBody =
  ...
  private record YandexGptBodyRequestDto(
      String modelUri, CompletionOptionsDto completionOptions, List<MessageDto> messages) {
