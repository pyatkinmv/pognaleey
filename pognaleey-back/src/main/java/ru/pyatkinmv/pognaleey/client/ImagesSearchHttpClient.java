...
public class ImagesSearchHttpClient {
    ...
    private static final String URL_FORMAT = "https://yandex.ru/images-xml?apikey=AQVN2obLDvxDcOVmoY2IdpcpXk30Cwzb5fHRKfcY&folderid=b1g4e7108ae9pp9j7tn7&text=%s&isize=large&groupby=attr=ii.groups-on-page=1&itype=png&iorient=square";
    //&iorient=square
...
//                .queryParam("folderid", "b1g4e7108ae9pp9j7tn7")
////                .queryParam("groupby", "attr=ii.groups-on-page=1")
//                .queryParam("iorient", "square")
//                .queryParam("apikey", "AQVN2obLDvxDcOVmoY2IdpcpXk30Cwzb5fHRKfcY")
