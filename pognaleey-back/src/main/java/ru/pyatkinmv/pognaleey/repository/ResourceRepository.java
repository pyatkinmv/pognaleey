...
public class ResourceRepository {
  ...
  public ResourceData findById(Long id) {
    return jdbcTemplate.queryForObject(
        FIND_BY_ID, ResourceDataRowMapper.RESOURCE_DATA_ROW_MAPPER, id);
  }

  private static class ResourceDataRowMapper implements RowMapper<ResourceData> {

    private static final RowMapper<ResourceData> RESOURCE_DATA_ROW_MAPPER =
        new ResourceDataRowMapper();
